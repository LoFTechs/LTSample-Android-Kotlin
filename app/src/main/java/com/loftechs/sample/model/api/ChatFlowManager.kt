...
object ChatFlowManager {
    ...
    fun createSingleChannel(receiverID: String, memberModel: LTMemberModel): Observable<LTCreateChannelResponse> {
        return getIMManager(receiverID)
                .flatMap {
    ...
    fun setChannelAvatar(receiverID: String, chID: String, uri: Uri): Observable<LTChannelProfileFileResponse> {
        return getIMManager(receiverID)
                .flatMap {
    ...
    fun deleteChannelMessages(receiverID: String, channelID: String): Observable<LTDeleteChannelMessageResponse> {
        return getIMManager(receiverID)
                .flatMap {
